...
>[0];
// eslint-disable-next-line @typescript-eslint/no-explicit-any -- Visitor function types are complex and not worth typing in detail here
...
export const catenarycloudWebRules = {
