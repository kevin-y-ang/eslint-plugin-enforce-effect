...
import requireEslintDisableJustification from "../../src/rules/require-eslint-disable-justification.js";
...
ruleTester.run("require-eslint-disable-justification", requireEslintDisableJustification, {
  valid: [
