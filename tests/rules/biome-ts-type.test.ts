...
ruleTester.run(
  ...
  biomeRules["no-effect-type-alias"],
  {
...
ruleTester.run(
  ...
  biomeRules["no-fromnullable-nullish-coalesce"],
  {
...
ruleTester.run(
  ...
  biomeRules["no-model-overlay-cast"],
  {
...
ruleTester.run(
  ...
  biomeRules["no-option-boolean-normalization"],
  {
    valid: [
      {
...
ruleTester.run(
  ...
  biomeRules["no-unknown-boolean-coercion-helper"],
  {
...
ruleTester.run(
  ...
  biomeRules["no-string-sentinel-const"],
  {
    valid: [{ code: `${effectImport}\nconst status = 1;` }],
    invalid: [
      {
...
ruleTester.run(
  ...
  biomeRules["no-string-sentinel-return"],
  {
