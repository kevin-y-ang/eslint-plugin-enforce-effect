...
ruleTester.run(
  ...
  catenarycloudRules["no-atom-registry-effect-sync"],
  {
    valid: [
      {
...
ruleTester.run(
  ...
  catenarycloudRules["no-inline-runtime-provide"],
  {
    valid: [
      {
...
ruleTester.run("no-react-state", catenarycloudRules["no-react-state"], {
...
ruleTester.run(
  ...
  catenarycloudRules["no-render-side-effects"],
  {
    valid: [
      {
...
ruleTester.run(
  ...
  catenarycloudRules["no-wrapgraphql-catchall"],
  {
    valid: [
      {
